...
import { Search, MapPin, ChevronDown, Filter, ShieldCheck } from 'lucide-react';
    ...
    <div className="relative bg-white border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-semibold mb-6">
          ...
          <p className="text-lg text-slate-500 mb-8 max-w-2xl mx-auto font-normal">
            {t.hero.subtitle}
          </p>
        </div>

        {/* Search Component - SaaS Filter Bar Style */}
        <div className="bg-white p-1.5 rounded-xl border border-slate-200 shadow-xl shadow-slate-200/50 max-w-3xl mx-auto flex flex-col md:flex-row gap-2">
          ...
          <div className="md:w-64 flex items-center bg-transparent px-4 py-2 relative">
            ...
            <ChevronDown className="absolute right-4 text-slate-400 pointer-events-none" size={14} />
          </div>

          <button 
            onClick={() => fetchListings()}
            className="bg-slate-900 hover:bg-black text-white font-medium rounded-lg px-6 py-3 md:py-0 transition-all text-sm shadow-sm"
          >
            {t.hero.searchBtn}
          </button>
        </div>

        <div className="mt-8 flex justify-center gap-8 text-xs font-medium text-slate-500">
