        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight leading-tight">
              {t.trust.titleStart} <span className="text-indigo-400">{t.trust.titleEnd}</span>.
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                ...
                <div>
                  <h3 className="font-bold text-lg text-white">{t.trust.bankIdTitle}</h3>
                  <p className="text-slate-400 text-sm mt-1">{t.trust.bankIdDesc}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                ...
                <div>
                  <h3 className="font-bold text-lg text-white">{t.trust.moneyTitle}</h3>
                  <p className="text-slate-400 text-sm mt-1">{t.trust.moneyDesc}</p>
                </div>
              </div>
            </div>
             ...
             <div className="bg-white rounded-2xl p-6 text-slate-900 shadow-2xl shadow-indigo-500/10 transform md:rotate-2 hover:rotate-0 transition-transform duration-500 border border-slate-200">
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-100">
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-sm text-slate-900">{t.trust.demoApproved}</p>
                        <p className="text-xs text-slate-500">{t.trust.demoGateway}</p>
                      </div>
                   </div>
                ...
                <div className="bg-slate-50 rounded-xl p-4 mb-4 border border-slate-100">
                   <div className="flex gap-3">
                      ...
                      <div>
                        <p className="font-bold text-sm text-slate-900">{t.trust.demoItem}</p>
                        <p className="text-xs text-slate-500">{t.trust.demoDelivery}</p>
                      </div>
                   </div>
                </div>
                <div className="text-center">
                   <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold flex items-center justify-center gap-1">
                      <ShieldCheck size={10} /> {t.trust.demoVerified}
                   </p>
                </div>
             </div>
          </div>
